...
In this paper we spectroscopically scrutinize 24 of the brightest stars residing in the central $25\arcsec \times 38\arcsec$ of the SN 1604 (Kepler) supernova remnant  to search for a possible surviving companion star. We can rule out a red giant companion star with high certainty - a progenitor indicated by some models of the supernova remnant.  Furthermore, we find no star that exhibits properties uniquely consistent with those expected of a donor star down to $L>10\lsun $. While the 
