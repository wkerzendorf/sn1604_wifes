...
& \colhead{NOMAD ID} & \colhead{B\tablenotemark{d}} & \colhead{V\tablenotemark{d}} & \colhead{R\tablenotemark{d}}
...
\enddata
\tablenotetext{a}{Assuming the candidate to be at the distance of SN1604 by using the distance modulus $m_V - M_V=16.3$. If we assumed a distance of 6~kpc and an extinction of $A_V$=2.8
the luminosity increases by a factor of 1.4}
...
\tablenotetext{d}{Photometry from the NOMAD catalogue}
\end{deluxetable}
